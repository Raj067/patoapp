# Generated by Django 3.2.5 on 2022-07-09 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField()),
                ('expenses_category', models.CharField(choices=[('direct', 'Direct Expenses'), ('indirect', 'Indirect Expenses')], max_length=200)),
