"""
Django settings for patosite project.
...
ALLOWED_HOSTS = ['50.116.38.43', '50.116.38.43:8000', '127.0.0.1']
...
WSGI_APPLICATION = 'patosite.wsgi.application'
