...
class PurchasesReports extends StatefulWidget {
  const PurchasesReports({Key? key}) : super(key: key);

  @override
  State<PurchasesReports> createState() => _PurchasesReportsState();
}

class _PurchasesReportsState extends State<PurchasesReports> {
  int totalAmount = 0;
  int totalBalance = 0;
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text("Tsh ${formatter.format(totalBalance)}"),
                      ],
                    ),
                  ],
                ),
